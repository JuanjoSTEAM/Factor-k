...
const translations = {
  en: {
    ...
    student: {
      ...
      cosmosLab: "Cosmos Lab",
      ethicsSandbox: "Ethics Sandbox",
  ...
  es: {
    ...
    student: {
      ...
      greatLibrary: "La Gran Biblioteca",
      cosmosLab: "Laboratorio Cosmos",
      ethicsSandbox: "Sandbox de Ética",
  ...
  de: {
    ...
    student: {
      ...
      greatLibrary: "Die Große Bibliothek",
      cosmosLab: "Kosmos Labor",
      ethicsSandbox: "Ethik Sandbox",
